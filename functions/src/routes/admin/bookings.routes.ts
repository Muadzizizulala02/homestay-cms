...
// just the refund action, callable once that screen exists. ToyyibPay has no confirmed refund
// API, so this only updates our own records — the admin still processes the actual refund
// through ToyyibPay themselves.
router.post(
  '/:id/refund',
